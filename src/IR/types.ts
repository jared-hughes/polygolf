...
export function type(type: Type | "void" | "boolean" | "int64"): Type {
  switch (type) {
    ...
    case "boolean":
      return booleanType;
    case "int64":
      return integerType(-9223372036854775808n, 9223372036854775807n);
    default:
      return type;
  }
}
...
export function setType(member: Type | "void" | "boolean" | "int64"): Type {
  return {
    kind: "Set",
    member: type(member),
  };
...
export function listType(member: Type | "void" | "boolean" | "int64"): Type {
  return {
    kind: "List",
    member: type(member),
  };
...
export function arrayType(
  member: Type | "void" | "boolean" | "int64",
  length: number
): Type {
  return {
    kind: "Array",
